		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9">
				<div class="presentation-main-panel">
				    ...
				    <ol>
				        <li>The speakers listed for your presentation will each be notified using the email addresses you’ve provided. Each speaker will be asked to provide a few additional details. Please help ensure that your speakers follow the instructions contained in the email.</li>
